...
struct MinHeapNode* newMinHeapNode(long long v, long long key)
{
...
void decreaseKey(struct MinHeap* minHeap, long long v, long long key)
{
...
void PrimMST(struct Graph* graph)
{
    ...
    long long parent[V];   // Array to store constructed MST
    long long key[V];      // Key values used to pick minimum weight edge in cut
